...
<?php include("abtop.php");?>
  ...
  <title>Abocent Capitals - Our services</title>
        ...
        <div class="row justify-content-md-center">
			...
			?>
				<h1 class="mbr-section-title align-center mbr-bold pb-3 mbr-fonts-style display-1">
                   Our&nbsp;<span style="font-weight: normal;"> Services</span></h1>
    ...
    <div class="container">
        <div class="row justify-content-md-center">
            <div style="font-size:15pt;padding-bottom:30pt" class="col-md-12">
             ...
             <?php
			 if(x_count("siteinfo","type='service' AND status='1'") > 0){
				 foreach(x_select("entry","siteinfo","type='service' AND status='1'","1","id") as $key){
					$entry = $key["entry"]; 
					echo $entry;
				 }
			 }
