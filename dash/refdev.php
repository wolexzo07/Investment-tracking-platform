<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 upo">
			...
			<div id="reshape" class="panel panel-heading" style="text-transform:uppercase;">
				<i class="fa fa-qrcode"></i>&nbsp;&nbsp; Referral Link 
			</div>
...
echo "";
 ...
 $trkk = "https://$host/ApplicationForm?ref_code=".$tok;
QRcode::png("$trkk", "$refcodee", "H", 4, 2);
}
			?>
			<img src="<?php echo $refcodee;?>" class="qrcod"/><br/>
		<button data-clipboard-text="https://<?php echo $host;?>/ApplicationForm?ref_code=<?php echo $tok;?>" class="btn btn-success"><i class="fa fa-link"></i> copy link</button>
			</td>
			<td>
			<p class='lin'><a href="https://<?php echo $host;?>/ApplicationForm?ref_code=<?php echo $tok;?>">https://<?php echo $host;?>/ApplicationForm?ref_code=<?php echo $tok;?></a></p>
			</td>
			</tr>
