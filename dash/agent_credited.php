...
//confirming that this referred user by agent is credited once started
  ...
  x_insert("type,title,user_id,message,status,rtime,stime","notifyme","'p','REFERRAL BONUS OF <b>NGN $agentcredit </b> WAS CREDITED TO YOUR WALLET','$refid','<p>Hi <b>$refname</b>,</p>Your wallet balance has been credited with referral bonus of <b>NGN $agentcredit</b> for referring <b>$refname ($refemail)</b> to iqgames. This money can be withdrawn <b>(because you are an agent)</b> or used to play game(s) on our platform to earn bigger amount. Thank you.<br/><br/><b>IQ-GAMES TEAM</b> ','0','$rtimen','$stimen'","","Failed to send notification");
