...
foreach(x_select("wallet_balance,email,name,mobile,account_name,bank_name,account_number","userdb_bank","id='$userid'","1","id") as $key){
  $name = $key["name"];$email = $key["email"];$mobile = $key["mobile"];
  $wb = $key["wallet_balance"];
}
  }else{
$name = "";$email = "";$mobile = "";$wb=0;
}
...
<th>
<?php echo "NGN ".number_format($wb,2);?>
</th>
<th>
