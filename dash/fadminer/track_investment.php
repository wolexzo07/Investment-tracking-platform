...
<div class="row">
<div class="col-md-4">
<h4 class="lefttrack"><button onclick="load('track_investment')" class="btn btn-success"><i class="fa fa-calculator"></i></button> &nbsp;&nbsp;TRACK <font class="spart">INVESTMENTS</font></h4>
</div>
<div class="col-md-4">
		<script>
		 function searcher(){
...
function changePagination(pageId){
     ...
     $.ajax({
           type: "POST",
           url: "trackinvestments?call=<?php if(isset($_GET['call'])){echo $_GET['call'];}else{} ?>&sm=<?php echo md5(rand(123,89292));?>",
           data: dataString,
           cache: false,
