  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav">
        <li class="active" onclick="load('homedash')"><a href="#"><i class="fa fa-home homo"></i> Home</a></li>
       
        
      </ul>
      <ul class="nav navbar-nav navbar-right">
	  <li><a href="#"><i class="fa fa-bell"></i> <span class="badge">0</span></a></li>
      <li onclick="load('profile')"><a href="#"><i class="glyphicon glyphicon-user"></i> <font class="r">Profile</font></a></li>
