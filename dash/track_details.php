...
<h4 class="walletFunder"><i class="fa fa-credit-card"></i>&nbsp;&nbsp; Deposits <font class="colorg">/ Withdrawals </font></h4>
...
if(x_count("transaction","owner='$userme' LIMIT 1") > 0){
	...
	x_print("<p class='text-center'><i class='fa fa-signal hipe'></i><br/></br>No deposit Transaction found<br/><br/></p>");
}
...
if(x_count("withdrawalbase","email='$userme' AND type='withdrawal' LIMIT 1") > 0){
	...
	x_print("<hr/><p class='text-center'><i class='fa fa-credit-card hipe'></i><br/></br>No Withdrawal Transaction found<br/><br/></p>");
}
