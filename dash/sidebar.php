...
<nav id="sidebar">
  ...
  <?php $userbiz = $_SESSION["IQGAMES_NAME_2018_VISION"];?>
	<button onclick="alert('I am <?php echo $userbiz;?>.')" class="btn btn-info" style="text-align:left;color:white;background-color:;margin-top:0pt;border:1px solid white;width:100%;font-size:;font-weight:none;">
    <?php
