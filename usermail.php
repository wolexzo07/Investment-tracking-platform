<?php
$subject = "ABOCENT - NEW USER REGISTRATION";

$message = "
<html>
<head>
<title>ABOCENT - NEW USER REGISTRATION</title>
</head>
<body>
...
<center>
<h2 style='text-align:center;display:block;'><img src='https://abocent.com/image/logboss.png' style='width:80px;padding:0px;'/> <br/><font style='color:green;'>iqgames</font>.app</h2></center>
</div>
<div style='padding:1%;'>
<p>
...
<p><a href='https://abocent.com/activateaccount?key=$tok&userid=$email'>Activate account</a></p>
or copy the link below and directly paste it into your browser<br/><br/>
https://abocent.com/activateaccount?key=$tok&userid=$email
</center>
<br/><br/>
<script>

function fun(){
window.location='https://abocent.com/activateaccount?key=$tok&userid=$email';
}
</script>
<style type='text/css'>
.br{
